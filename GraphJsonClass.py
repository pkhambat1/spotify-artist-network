...
class GraphJson:
    ...
    def add(self, artist_id: str, name: str, popularity: int, related_artists: list, breadth: int, visited: set, queue: Queue, num_nodes: int) -> None:
        ...
        for related_artist in related_artists:
            ...
            if related_artist_id not in visited:
                ...
                self.nodes.append(Node(related_artist_name, popularity).to_dict())

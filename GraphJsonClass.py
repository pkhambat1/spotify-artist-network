...
class Node:
    ...
    def to_dict(self):
        return {"id": self.id, "name": self.name, "popularity": self.popularity}
...
class GraphJson:
    ...
    def add(self, id: str, name: str, related_artists: list, breadth: int, visited: set, queue: Queue, num_nodes: int) -> None:
        ...
        for related_artist in related_artists:
            ...
            if related_artist_id not in visited:
                ...
                self.nodes.append(Node(related_artist_id, related_artist_name, related_artist_popularity).to_dict())
